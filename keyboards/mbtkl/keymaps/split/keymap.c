...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_default(
        KC_F1,         KC_F2,   KC_F3,  KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9,   KC_F1O,  KC_F11,  KC_F12,  KC_DEL,  KC_HOME, KC_PGUP,
        ...
        MO(_LAYER2),   XXXXXXX, KC_ALT, XXXXXXX,      LT(_LAYER1, KC_SPC),        KC_SPC,  KC_RALT, XXXXXXX, KC_RGUI, KC_LEFT, KC_DOWN, KC_RIGHT
    ),
    ...
    [_LAYER2] = LAYOUT_default(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RESET,   XXXXXXX, XXXXXXX, KC_RALT, KC_RCTL, KC_DEL,  KC_VOLD,          XXXXXXX,
